...
function detailToForm(d: Detail): FormState {
  return {
    ...
    brandAccent: typeof d.config.brandAccent === "string" ? d.config.brandAccent : "#38bdf8",
    brandBg: typeof d.config.brandBg === "string" ? d.config.brandBg : "#0f172a",
    brandBgEnd: typeof d.config.brandBgEnd === "string" ? d.config.brandBgEnd : "",
    brandFg: typeof d.config.brandFg === "string" ? d.config.brandFg : "#e2e8f0",
    description: d.config.description ?? "",
    kind: d.kind,
    name: d.config.name ?? d.name,
    noPiiVerified: d.config.noPiiVerified === true,
    pattern: typeof d.config.pattern === "string" ? d.config.pattern : "none",
