...
import { OpsKillSwitchesClient } from "./ops-kill-switches-client";
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const labels = pickLabels(t, "opsKillSwitches");
  return <OpsKillSwitchesClient common={t.adminConsole.common} labels={labels} />;
}
