...
import { LegalCookiesAdminClient } from "./legal-cookies-admin-client";
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const labels = { ...pickLabels(t, "legalPolicyAdmin"), ...pickLabels(t, "legalCookiesAdmin") };
  return (
    <LegalCookiesAdminClient
      common={t.adminConsole.common}
      labels={{ ...labels, title: labels.titleCookies ?? labels.title ?? "Cookies" }}
    />
  );
}
