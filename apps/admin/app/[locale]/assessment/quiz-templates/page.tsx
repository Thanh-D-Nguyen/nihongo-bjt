...
import { QuizTemplatesAdminClient } from "./quiz-templates-client";
...
export default async function Page({ params }: { params: Promise<{ locale: keyof typeof messages }> }) {
  ...
  const sec = (labels?.quizTemplates as Record<string, string>) ?? {};
  ...
  return <QuizTemplatesAdminClient common={common} labels={sec} locale={locale} />;
}
