...
import { RemediationAdminClient } from "./remediation-client";
...
export default async function Page({ params }: { params: Promise<{ locale: keyof typeof messages }> }) {
  ...
  const sec = (labels?.remediation as Record<string, string>) ?? {};
  ...
  return <RemediationAdminClient common={common} labels={sec} locale={locale} />;
}
