    ...
    Lesson(
      ...
      sections: [
        LessonSection(
          ...
          bodyJa: '尊敬語は相手の動作を高めて敬意を表します。'
              '謙譲語は自分の動作を低めて、相手を立てる表現です。',
          translationVi: 'Tôn kính ngữ nâng hành động của đối phương lên để '
              'bày tỏ sự kính trọng. Khiêm nhường ngữ hạ thấp hành động của '
              'bản thân để tôn trọng đối phương.',
        ),
        LessonSection(
          headingVi: 'Ví dụ thường gặp',
          bodyJa: '「言う」は、尊敬語で「おっしゃる」、'
              '謙譲語で「申す」になります。',
          translationVi: 'Động từ「言う」(nói) ở dạng tôn kính ngữ là '
              '「おっしゃる」, còn dạng khiêm nhường ngữ là「申す」.',
        ),
        LessonSection(
          headingVi: 'Lưu ý khi dùng',
          bodyJa: '相手には尊敬語、自分には謙譲語を使い、'
              '二つを混同しないように気をつけましょう。',
          translationVi: 'Dùng tôn kính ngữ cho đối phương và khiêm nhường '
    ...
    Lesson(
      ...
      sections: [
        LessonSection(
          ...
          bodyJa: 'はじめまして。'
              '株式会社さくらの田中と申します。',
          translationVi: 'Rất hân hạnh được gặp anh/chị. Tôi tên là Tanaka, '
        ...
        LessonSection(
          ...
          translationVi: 'Cảm ơn anh/chị đã dành thời gian hôm nay. '
    ...
    Lesson(
      ...
      sections: [
        LessonSection(
          ...
          translationVi: 'Tôi xin phép được trình bày ý kiến của mình có '
              'được không ạ?',
        ),
        LessonSection(
          headingVi: 'Xác nhận lại nội dung',
          bodyJa: '念のため、確認させていただきます。'
              '納期は来週の金曜日でよろしいですか。',
          translationVi: 'Để chắc chắn, cho tôi xác nhận lại. Thời hạn giao '
              'là thứ Sáu tuần sau, đúng không ạ?',
        ),
        LessonSection(
          headingVi: 'Đề xuất một cách lịch sự',
          bodyJa: 'もしよろしければ、別の案も検討してみてはいかがでしょうか。',
          translationVi: 'Nếu được, hay là chúng ta cùng cân nhắc thêm một '
    ...
    Lesson(
      ...
      sections: [
        LessonSection(
          ...
          bodyJa: 'いつもお世話になっております。'
              'さくら商事の田中です。',
          translationVi: 'Cảm ơn anh/chị đã luôn quan tâm giúp đỡ. Tôi là '
              'Tanaka từ công ty thương mại Sakura.',
        ),
        LessonSection(
          headingVi: 'Câu kết thúc',
          bodyJa: 'お忙しいところ恐れ入りますが、'
              'ご確認のほどよろしくお願いいたします。',
          translationVi: 'Xin lỗi vì đã làm phiền khi anh/chị đang bận, '
