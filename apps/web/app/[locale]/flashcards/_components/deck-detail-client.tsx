          ...
          {sortedCards.length > 0 ? (
            <DeckStudySession
              ...
              labels={{
                ...
                deckStudyHideReading: labels.deckStudyHideReading,
                deckStudyShowReading: labels.deckStudyShowReading,
                deckStudyTapToRevealReading: labels.deckStudyTapToRevealReading,
