...
2. Inspect current route/component/API client.
3. State design direction, learning outcome, acceptance criteria, and verification path.
4. Implement one vertical slice.
5. Add loading/error/empty/degraded/permission/feature-disabled states where relevant.
6. Apply learner page production gate, BJT UI/UX gate, Open Design BJT UI gate, and visual QA checklist.
7. Run/document checks.
</workflow>
