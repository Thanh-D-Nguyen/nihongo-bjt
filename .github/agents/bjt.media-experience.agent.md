...
Read `company/gates/world-class-learner-experience-gate.md` when reviewing learner-facing color, sound, motion, button feedback, or visual polish.
...
- Do not approve sound or motion unless it is user-triggered, mutable/quiet-mode compatible, and tied to a learning state.
</constraints>

<workflow>
1. Define the learning purpose of each media element.
2. Check asset provenance, license, accessibility, and fallback behavior.
3. Review color, motion, layout density, button feedback, sound triggers, quiet mode, and audio controls.
