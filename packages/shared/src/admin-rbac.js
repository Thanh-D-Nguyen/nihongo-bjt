...
export const CANONICAL_ADMIN_ROLE_PERMISSIONS = {
    "admin.super": ["*"],
...
export function allCanonicalAdminPermissions() {
    return Array.from(new Set(Object.values(CANONICAL_ADMIN_ROLE_PERMISSIONS)
        .flat()
