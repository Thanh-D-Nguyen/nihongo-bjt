...
export function hashSeedToUint32(input) {
    let h = 2166136261;
...
export function shuffleDeterministic(items, seedString) {
...
export const BATTLE_BOT_PROFILES = {
    bot_j1: {
        avatarFallback: "J1",
...
export function battleBotStateToRiveInput(state) {
    return `battle_${state}`;
}
export const DEFAULT_BATTLE_BOT_KEY = "bot_j3";
export function getBattleBotProfile(botKey) {
    return (BATTLE_BOT_PROFILES[botKey] ??
